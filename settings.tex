...
\begin{table}[htbp]
\centering
% 限制表格总宽度为单栏95%，确保与上下文对齐
\resizebox{0.95\linewidth}{!}{%
\begin{tabular}{@{}l>{\raggedright\arraybackslash}p{2cm}>{\arraybackslash$}p{3.5cm}<{$}@{}}
\toprule
符号/名称 & 含义 & \multicolumn{1}{c}{取值/范围} \\
\midrule
...
\begin{tabular}{@{}l>{\raggedright\arraybackslash}p{2.2cm}l@{}}
\toprule
符号/名称 & 含义 & 取值/范围 \\
\midrule
...
\centering
\resizebox{0.95\linewidth}{!}{%
\begin{tabular}{@{}l>{\raggedright\arraybackslash}p{2cm}>{\raggedright\arraybackslash}p{3.5cm}@{}}
\toprule
策略名称 & 含义 & 设置方式 \\
\midrule
Numba JIT 编译 & 核心几何计算加速 & 加速 \texttt{point\_segment\_dist2} 等函数 \\
...
\centering
\resizebox{0.95\linewidth}{!}{%
\begin{tabular}{@{}l>{\raggedright\arraybackslash}p{3.5cm}>{\raggedright\arraybackslash}p{2cm}@{}}
\toprule
文件编号 & 文件名 & 组合模式 \\
\midrule
