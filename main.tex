...
\DeclareCiteCommand{\cite}[\mkbibsuperscript]  % 包裹为上角标
{\usebibmacro{prenote}}
...
\end{abstract}
\\\noindent\textbf{关键词:} GDL, 随机纤维网络, 薄膜桥状 Binder, 网格生成, 建模，高斯平滑
\vspace{0.5em}
\noindent\hrule
\vspace{1em}
\end{@twocolumnfalse}
...
\input{generate_fiber.tex}

\subsection{\textbf{binder 生成策略}}

\input{generate_binder.tex}
